...
// Interface para o componente LessonItem
...
const Module1Page: React.FC = () => {
  ...
  const placeholderThumbnail = "https://i.postimg.cc/x81TSBRW/course-thumbnails-6c2c410a-c367-4393-a809-ecf48394060c-385b63aa70734a378d78de5a2cec6523.png";

  const lessons = [
    { number: "01", title: "Começando do ZERO!", thumbnailUrl: placeholderThumbnail },
    { number: "02", title: "Treino dos Polígonos!", thumbnailUrl: placeholderThumbnail },
    { number: "03", title: "Formas Básicas", thumbnailUrl: placeholderThumbnail },
    { number: "04", title: "Primeiros Traços", thumbnailUrl: placeholderThumbnail },
    { number: "05", title: "Exercícios Práticos", thumbnailUrl: placeholderThumbnail }
  ];
  ...
  const handleLessonClick = (lessonNumber: string) => {
    navigate(`/modulo/1/aula/${lessonNumber}`);
  };
      ...
      <section className="relative mt-6">
        <picture>
          <source 
            ...
            srcSet="https://i.postimg.cc/zv9FTXVL/01-B.png" // Versão para telemóvel
          />
          <img 
            src="https://i.postimg.cc/jS64JTK5/01-A.png" // Versão para PC
            alt="Banner Módulo 1"
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Módulo 01 - Instruções
          </h3>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Comece sua jornada no desenho com as instruções fundamentais. 
            Aprenda os conceitos básicos que serão a base para todo seu desenvolvimento artístico.
          </p>
        </div>
      </footer>
    </div>
