...
const HowToDraw6Page: React.FC = () => {
  ...
  const handleLessonClick = (lessonNumber: string) => {
    navigate(`/como-desenhar/6/aula/${lessonNumber}`);
  };
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/80 to-transparent p-8">
          <div className="container mx-auto">
            ...
            <h2 className="text-xl md:text-2xl text-gray-300 font-medium">
              Como Desenhar Personagens Chibi
            </h2>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
            Módulo 06 - Como Desenhar Personagens Chibi
          </h3>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Aprenda a desenhar seus personagens favoritos em um estilo fofo e simplificado.
          </p>
        </div>
      </footer>
    </div>
