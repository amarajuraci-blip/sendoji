...
const Module9Page: React.FC = () => {
  ...
  const handleLessonClick = (lessonNumber: string) => {
    navigate(`/modulo/9/aula/${lessonNumber}`);
  };
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Compreenda os princípios fundamentais do desenho de mãos e pés para dar naturalidade e fluidez aos seus personagens de anime
          </p>
        </div>
      </footer>
    </div>
