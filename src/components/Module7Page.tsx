...
const Module7Page: React.FC = () => {
  ...
  // ATUALIZADO: Lista de aulas do Módulo 7 com miniaturas locais
  const lessons = [
    { number: "01", title: "Felicidade", thumbnailUrl: "/images/mod/7_1.webp" }, // Atualizado
    { number: "02", title: "Raiva", thumbnailUrl: "/images/mod/7_2.webp" }, // Atualizado
    { number: "03", title: "Tristeza", thumbnailUrl: "/images/mod/7_3.webp" }, // Atualizado
    { number: "04", title: "Medo", thumbnailUrl: "/images/mod/7_4.webp" }, // Atualizado
    { number: "05", title: "Ódio", thumbnailUrl: "/images/mod/7_5.webp" } // Atualizado
  ];
  ...
  const handleLessonClick = (lessonNumber: string) => {
    navigate(`/modulo/7/aula/${lessonNumber}`);
  };
      ...
      <section className="relative mt-6">
        <picture>
          <source
            ...
            srcSet="/images/mod/capa7_cell.webp" // Banner celular atualizado
          />
          <img
            src="/images/mod/capa7_pc.webp" // Banner PC atualizado
            alt="Banner Módulo 7"
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Módulo 07 - Expressões Faciais
          </h3>
          <p className="text-gray-400 max-w-2xl mx-auto">
           Compreenda os princípios fundamentais das expressões faciais para transmitir emoções autênticas nos seus personagens de anime
          </p>
        </div>
      </footer>
    </div>
