...
const Module7Page: React.FC = () => {
  ...
  // ATUALIZADO: Lista de aulas do Módulo 7 com os novos títulos
  const lessons = [
    { number: "01", title: "Felicidade", thumbnailUrl: "https://i.postimg.cc/2SsL53CN/1.png" },
    { number: "02", title: "Raiva", thumbnailUrl: "https://i.postimg.cc/RF93c83P/2.png" },
    { number: "03", title: "Tristeza", thumbnailUrl: "https://i.postimg.cc/bJTZLTkq/3.png" },
    { number: "04", title: "Medo", thumbnailUrl: "https://i.postimg.cc/TPnL5GPL/4.png" },
    { number: "05", title: "Ódio", thumbnailUrl: "https://i.postimg.cc/vTZcKVtf/5.png" }
  ];
      ...
      <section className="relative mt-6">
        <picture>
          <source 
            ...
            srcSet="https://i.postimg.cc/8kqYR18B/07-B.png"
          />
          <img 
            src="https://i.postimg.cc/HsXh3fdG/07-A.png"
            alt="Banner Módulo 7"
