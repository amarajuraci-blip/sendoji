...
const Module10Page: React.FC = () => {
  ...
  const handleLessonClick = (lessonNumber: string) => {
    navigate(`/modulo/10/aula/${lessonNumber}`);
  };
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            Módulo 10 - Proporções
          </h3>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Compreenda os princípios fundamentais da proporção para construir personagens de anime equilibrados e harmoniosos
          </p>
        </div>
      </footer>
    </div>
