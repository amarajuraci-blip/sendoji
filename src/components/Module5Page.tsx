...
const Module5Page: React.FC = () => {
  ...
  // ATUALIZADO: Lista de aulas do Módulo 5 com miniaturas locais
  const lessons = [
    { number: "01", title: "Rosto Frontal", thumbnailUrl: "/images/mod/5_1.webp" }, // Atualizado
    { number: "02", title: "Perfil e 3/4\"", thumbnailUrl: "/images/mod/5_2.webp" }, // Atualizado
    { number: "03", title: "3/4\" Inverso e Invertido", thumbnailUrl: "/images/mod/5_3.webp" }, // Atualizado
    { number: "04", title: "Um Novo Esboço!", thumbnailUrl: "/images/mod/5_4.webp" }, // Atualizado
    { number: "05", title: "Entendendo o Novo Esboço", thumbnailUrl: "/images/mod/5_5.webp" }, // Atualizado
    { number: "06", title: "Rotação da Cabeça", thumbnailUrl: "/images/mod/5_6.webp" }, // Atualizado
    { number: "07", title: "Rotação Parte 2", thumbnailUrl: "/images/mod/5_7.webp" } // Atualizado
  ];
      ...
      <section className="relative mt-6">
        <picture>
          <source
            ...
            srcSet="/images/mod/capa5_cell.webp" // Banner celular atualizado
          />
          <img
            src="/images/mod/capa5_pc.webp" // Banner PC atualizado
            alt="Banner Módulo 5"
